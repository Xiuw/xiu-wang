                ...
                <h1 className="center white tc pb4 f2 f1-ns ma0 fw9">About Me</h1>
                  ...
                  <div className="center tc w-90 pa1 pb6 pt2 mw8" >
                    ...
                    <div className="w-30-l tc flex items-center mb2-l mb3">
                      <img alt="xiu" className="br-100 ba center b--white-80 bw1" width="130px" height="150px"src={xiu}/>
                    </div> 
                    </Fade>
                    ...
                    <a className="btnBtn ph4 pa2 fw6 pointer f5 no-underline white ba btn2 fl-l" 
