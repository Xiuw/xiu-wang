...
render(){
  ...
  return(
    <div className="w-100 pb5" id="contact">
        <h1 className="center w-100 navy fw6 tc pt5 f3 pl4 pr4 ma0">Let's get in touch!</h1>
        ...
        this.state.success? 
          <div className="center tc pa3 f3-ns f4 mt5 mb6">
              ...
              <p className="btnBtn fw5 ph4 pa3 input-reset pointer f5 dib gold b--gold ba mt4" 
               onClick={this.handleReturn}>Send another message</p>
          </div>
          :
          <main className="ml2 mr2 pb0 mt5">
              <div className="measure center "> 
                <fieldset id="contact_form" className="ba b--transparent ph0 mh0 pb1">
                   <div className="mt3">
                    <input placeholder="Name" className="f5 fw6 pa3 input-reset ba bg-transparent navy w-100" 
                    type="text" name="name"  id="name" onChange={this.handleChange}/>
                  </div>
                  <div className="mt3">
                    <input placeholder="Email" className="f5 fw6 pa3 input-reset  ba bg-transparent w-100 navy" 
                    type="email" name="email"  id="email" onChange={this.handleChange}/>
                  </div>
                  <div className="mt3">
                    <textarea  placeholder="Message" rows="6" className="f5 fw6 pa3 input-reset ba bg-transparent w-100 navy" 
                    type="text" name="message"  id="message" onChange={this.handleChange}/>
                  </div>
                </fieldset>

                <span className="navy f6">{this.state.error}</span>

                <div className="tc">
                  <p className="btnBtn linkBtn fw6 ph4 pa3 input-reset pointer f5  b--gold dib gold ba no-underline"
